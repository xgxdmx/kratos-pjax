...
<div class="kratos-post-inner">
    <header class="kratos-entry-header clearfix">
        ...
        <div class="kratos-post-meta">
            ...
            <a href="<?php the_permalink() ?>#respond"><i class="fa fa-commenting-o"></i> <?php comments_number('0','1','%');_e('条评论','moedog'); ?></a>
            </span>
            <span class="pull-left">
            <a href="<?php the_permalink() ?>"><i class="fa fa-eye"></i> <?php echo kratos_get_post_views();_e('次阅读','moedog'); ?></a>
            <a href="<?php the_permalink() ?>"><i class="fa fa-thumbs-o-up"></i> <?php if(get_post_meta($post->ID,'love',true)) echo get_post_meta($post->ID,'love',true); else echo '0';_e('人点赞','moedog'); ?></a>
            </span>
        </div>
    </header>
