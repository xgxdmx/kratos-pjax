...
function user_agent_show(){
    ...
    if($title&&$btitle){
        ...
        return '<div class="useragent"><img src="'.$uapic.'/static/images/ua/'.$bcode.'.png"> '.$btitle.' <img src="'.$uapic.'/static/images/ua/'.$code.'.png" style="margin-left:5px"> '.$title.' '.$version.'</div>';
    }else return null;
}
